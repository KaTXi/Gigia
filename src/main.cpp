...
// Copyright (c) 2014 The Gigiacoin developers
...
#if defined(NDEBUG)
# error "Gigiacoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xc4df8e243c2148d875fc5df7c4b1c179d344ed44eb5ea61cf6ed16f92533023e");
...
const string strMessageMagic = "Gigiacoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Litecoin: 840k blocks in ~4 years Gigiacoin: 1000k blocks ~ 100 days

    return nSubsidy + nFees;
}


static const int64 nTargetSpacing = 1.5 * 60; // Litecoin: 2.5 minutes ; Gigiacoin 2.25 minutes
static const int64 nOriginalInterval = 160; //160 blocks = 6 hrs
//static const int64 nTargetTimespan = 6 * 60 * 60; // Litecoin: 3.5 days ; Gigiacoin: 6 hours
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5b93d91de717a160db4079b60eb94c719486725f52944bae993492ededab913c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1404486568;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086509739;

        if (fTestNet)
        {
            block.nTime    = 1404481276;
            block.nNonce   = 2785203;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6e343e0532da440178c0b3cca9c9b44f55155702c976cb502d703e532a2f9709"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GigiacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GigiacoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("GigiacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("gigiacoin-miner");
	...
	//
        ...
        printf("Running GigiacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GigiacoinMiner terminated\n");
        throw;
    }
}
